...
export default function HotOrNotPage() {
  ...
  return (
    ...
    >
      ...
      <div
        className="w-full max-w-[480px] md:max-w-[900px] mx-auto"
        style={{
          display: "flex",
      ...
      >
        ...
        <div className={result ? "flex flex-col md:flex-row gap-6 w-full items-start" : "w-full max-w-[480px] mx-auto flex flex-col gap-4"}>
          
          {/* Left Column: Photo Slots */}
          <div className={result ? "w-full md:w-[380px] flex-shrink-0 flex flex-col gap-4" : "w-full flex flex-col gap-4"}>
            {/* ── Photo slots row ── */}
